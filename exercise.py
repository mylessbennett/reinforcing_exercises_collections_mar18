...
for count, i in enumerate(dict['response']['results']):
    if dict['response']['results'][count]['type'] == 'article':
        dict['response']['results'][count]['views'] = 0

print(dict['response']['results'])


def read_article(dict):
    article = randint(0, len(dict['response']['results']) - 1)
    dict['response']['results'][article]['views'] += 1
    return
...
def display_views(dict):
    for count, i in enumerate(dict['response']['results']):
        title = dict['response']['results'][count]['webTitle']
        views = dict['response']['results'][count]['views']
